.class public Lcom/htc/calendar/utils/Regex;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/htc/calendar/utils/Regex;->REGEX_STRING:[Ljava/lang/String;

    .line 182
    sget-object v0, Lcom/htc/calendar/utils/Regex;->REGEX_STRING:[Ljava/lang/String;

    array-length v0, v0

    new-array v0, v0, [Ljava/util/regex/Pattern;

    sput-object v0, Lcom/htc/calendar/utils/Regex;->PATTERN_POOL:[Ljava/util/regex/Pattern;
    ...
    sput-object v0, Lcom/htc/calendar/utils/Regex;->mLock:Ljava/lang/Object;
...
.method public static getInstance()Lcom/htc/calendar/utils/Regex;
    .locals 4
    ...
    .line 190
    .local v0, reg:Lcom/htc/calendar/utils/Regex;
    sget-object v3, Lcom/htc/calendar/utils/Regex;->mLock:Ljava/lang/Object;

    monitor-enter v3

    .line 191
    :try_start_0
    sget-object v2, Lcom/htc/calendar/utils/Regex;->mCache:Ljava/lang/ref/SoftReference;
    ...
    check-cast v2, Lcom/htc/calendar/utils/Regex;
    ...
    .line 193
    new-instance v1, Lcom/htc/calendar/utils/Regex;

    invoke-direct {v1}, Lcom/htc/calendar/utils/Regex;-><init>()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 194
    .end local v0           #reg:Lcom/htc/calendar/utils/Regex;
    .local v1, reg:Lcom/htc/calendar/utils/Regex;
    :try_start_1
    new-instance v2, Ljava/lang/ref/SoftReference;

    invoke-direct {v2, v1}, Ljava/lang/ref/SoftReference;-><init>(Ljava/lang/Object;)V

    sput-object v2, Lcom/htc/calendar/utils/Regex;->mCache:Ljava/lang/ref/SoftReference;
    :try_end_1
    ...
    .line 196
    .end local v1           #reg:Lcom/htc/calendar/utils/Regex;
    :cond_0
    :try_start_2
    monitor-exit v3
    ...
    .line 191
    .restart local v0       #reg:Lcom/htc/calendar/utils/Regex;
    :cond_1
    const/4 v0, 0x0
    ...
    .restart local v1       #reg:Lcom/htc/calendar/utils/Regex;
    :catchall_1
    move-exception v2
...
.method public getPattern(I)Ljava/util/regex/Pattern;
    ...
    .prologue
    .line 201
    sget-object v1, Lcom/htc/calendar/utils/Regex;->mLock:Ljava/lang/Object;

    monitor-enter v1

    .line 202
    :try_start_0
    sget-object v0, Lcom/htc/calendar/utils/Regex;->PATTERN_POOL:[Ljava/util/regex/Pattern;
    ...
    sget-object v2, Lcom/htc/calendar/utils/Regex;->REGEX_STRING:[Ljava/lang/String;
